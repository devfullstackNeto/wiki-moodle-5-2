...
<StepByStep introduction="Configure primeiro o que o estudante fará; depois conecte avaliação, acompanhamento e operação da correção.">
  <StepItem title="Ative o modo de edição" screenshotTitle="Ativar o modo de edição no curso" screenshotDescription="Capture o cabeçalho do curso com o controle do modo de edição visível, sem dados pessoais e com o nome do curso fictício." caption="Ative o modo de edição antes de adicionar ou alterar atividades." alt="Botão para ativar o modo de edição no Moodle.">
