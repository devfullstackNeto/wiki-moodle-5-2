...
<StepByStep introduction="Primeiro configure o contêiner do Questionário; depois adicione e organize as questões.">
  ...
  <StepItem title="Crie o Questionário" description="Adicione a atividade, informe Nome e Descrição e escreva instruções sobre tentativas, navegação, materiais e suporte." expected="O estudante conhece as regras antes de iniciar uma tentativa." />
