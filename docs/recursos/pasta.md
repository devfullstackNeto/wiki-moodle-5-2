...
---
<ObjectiveCard>Ao final, você saberá decidir quando usar **Pasta**, configurar o essencial e verificar a experiência do estudante.</ObjectiveCard>

## Quando usar

Use Pasta quando os arquivos formam um conjunto pequeno e coerente. Considere outra solução como depósito de dezenas de documentos sem ordem ou descrição.
...
<NavigationPath path="No curso → ativar o modo de edição → adicionar uma atividade ou recurso → Pasta" />
