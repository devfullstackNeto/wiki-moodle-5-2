...
---
<ObjectiveCard>Aplique estrutura, contraste, alternativas, legendas e operação por teclado.</ObjectiveCard>

## Entenda antes de agir

Use títulos em ordem, links descritivos, alt contextual e legendas. Não dependa de cor, posição, áudio ou imagem para transmitir informação.
