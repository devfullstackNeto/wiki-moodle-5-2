...
<ScreenshotPlaceholder id="SOLICITAR-SUPORTE-01" title="Tela de referência" description="Captura mínima necessária para apoiar solicitar suporte com informações úteis, após validação institucional." alt="Tela do Moodle 5.2 relacionada a solicitar suporte com informações úteis." src="" />
